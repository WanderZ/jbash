...
public class jBash implements jBashConstants {
 ...
 public static void main(String args[])throws ParseException{
  ...
  static final public void matchQuadre() throws ParseException {
    jj_consume_token(DOPPIAQUADRAPERTA);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DOPPIAQUADRAPERTA:
      matchQuadre();
      break;
    default:
      jj_la1[0] = jj_gen;
    ...
    jj_consume_token(DOPPIAQUADRACHIUSA);
  }
